        ...
        <div className='lg:col-start-4 lg:col-end-6'>
          <div className='w-full rounded-lg bg-white md:shadow-lg px-10 py-12 dark:bg-slate-800'>
            ...
            <form className='grid mt-6 gap-4'>
              <input type="text" name="firstName" placeholder='Имя' className='bg-slate-100 dark:bg-slate-700 text-black dark:text-white rounded-md py-2 px-4'></input>
              <input type="text" name="lastName" placeholder='Фамилия' className='bg-slate-100 dark:bg-slate-700 text-black dark:text-white rounded-md py-2 px-4 '></input>
